...
def get_coords_color(opt):
    ...
    inst_label_file = osp.join(
        opt.prediction_path, "gt_instance", opt.room_name + ".txt"
    )
    ...
    if opt.task == "semantic_gt":
        ...
        semantic_file = os.path.join(
            opt.prediction_path, "semantic_pred", opt.room_name + ".npy"
        )
        assert os.path.isfile(semantic_file), "No semantic result - {}.".format(
            semantic_file
        )
        ...
        offset_file = os.path.join(
            opt.prediction_path, "offset_pred", opt.room_name + ".npy"
        )
    ...
    # same color order according to instance pointnum
        ...
        instance_file = os.path.join(
            opt.prediction_path, "pred_instance", opt.room_name + ".txt"
        )
